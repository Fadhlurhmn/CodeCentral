...
<div class="h-screen flex flex-row flex-wrap">
    ...
    <div class="flex-grow bg-white">
        ...
        <div class="w-full h-fit min-w-max p-5 ">
            ...
            <form id="kategori_bansos" method="post" action="{{ url('rw/kategori_bansos/') }}" class="px-10 py-10 bg-white outline-none outline-4 outline-gray-700 rounded-xl">
                @csrf
                ...
                <div class="flex py-2 mt-5 justify-start group col-span-full">
                    <a href="{{ url('rw/bansos/') }}" class="text-white bg-red-600 hover:bg-red-700 focus:ring-4 focus:outline-none focus:ring-gray-400 font-medium rounded-lg text-xs sm:w-auto px-5 py-2.5 text-center mr-2">Batal</a>
