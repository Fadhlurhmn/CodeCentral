...
<div class="h-screen flex flex-row flex-wrap">
    ...
    <div class="flex-grow bg-white">
        ...
        <div class="w-full h-fit min-w-max p-5 ">
            ...
            <form id="kategori_bansos" method="post" action="{{ url('rw/kategori_bansos/update') }}" class="px-10 py-10 bg-white outline-none outline-4 outline-gray-700 rounded-xl">
                @csrf
                                ...
                                @foreach ($bansos as $item)
                                    <tr>
                                        ...
                                        <td class="border px-4 py-2 text-center">
                                            <a href="{{ url('rw/kategori_bansos/' . $item->id_bansos) }}" class="btn btn-danger ml-2 mr-2 flex-col" onclick="return confirm('Apakah Anda yakin ingin menghapus data kategori ini?')"><i class="fas fa-trash"></i></a>
                                        </td>
                                    </tr>
                                @endforeach
                            </tbody>
                ...
                <div class="flex py-2 mt-5 justify-start group col-span-full">
                    <a href="{{ url('rw/bansos/index') }}" class="text-white bg-red-600 hover:bg-red-700 focus:ring-4 focus:outline-none focus:ring-gray-400 font-medium rounded-lg text-xs sm:w-auto px-5 py-2.5 text-center mr-2">Batal</a>
