...
<div class="h-screen flex flex-row flex-wrap">
    @include('layout.rt_sidebar') <!-- Menyertakan sidebar -->
    ...
    <div class="px-5 pt-5 flex-grow bg-white border-t-2 border-teal-500">
        ...
        <div class="w-full h-fit p-5">
            <form id="form_profil_edit" action="{{ url('rt/profil') }}" method="POST">
                ...
                <div class="px-10 py-10 min-w-full bg-white grid grid-cols-4 gap-x-20 gap-y-2 outline-none outline-4 outline-gray-700 rounded-xl">
                    ...
                    <div class="flex col-span-2 mt-4">
                        <a href="{{ url('rt') }}" class="text-white bg-red-600 hover:bg-red-700 focus:ring-4 focus:outline-none focus:ring-gray-400 font-medium rounded-lg text-xs sm:w-auto px-5 py-2.5 text-center mr-2">Batal</a>
