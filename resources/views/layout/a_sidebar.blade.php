  ...
  <div id="sideBar" class="relative flex flex-col flex-wrap bg-white border-r border-gray-300 p-6 flex-none w-52 md:-ml-64 md:fixed md:top-0 md:z-30 md:h-screen md:shadow-xl animated duration-500 ease-in-out">
    ...
    <a href="{{ url('/admin/akun') }}" class="mb-3 capitalize font-medium text-sm hover:text-teal-600 transition ease-in-out duration-500">
        <i class="fas fa-user text-xs mr-2"></i>
        Akun
    </a>

    <a href="{{ url('/admin/bansos') }}" class="mb-3 capitalize font-medium text-sm hover:text-teal-600 transition ease-in-out duration-500">
    ...
    <a href="{{ url('/admin/promosi') }}" class="mb-3 capitalize font-medium text-sm hover:text-teal-600 transition ease-in-out duration-500">
        <i class="fas fa-ad text-xs mr-2"></i>
        Promosi
    </a>

    <a href="{{ url('/admin/surat') }}" class="mb-3 capitalize font-medium text-sm hover:text-teal-600 transition ease-in-out duration-500">
        <i class="fas fa-envelope text-xs mr-2"></i>
        Surat
    </a>

    <a href="{{ url('/admin/jadwal') }}" class="mb-3 capitalize font-medium text-sm hover:text-teal-600 transition ease-in-out duration-500">
        <i class="far fa-calendar-alt text-xs mr-2"></i>
        Jadwal
    </a>

    <a href="{{ url('/admin/keuangan') }}" class="mb-3 capitalize font-medium text-sm hover:text-teal-600 transition ease-in-out duration-500">
        <i class="fas fa-coins text-xs mr-2"></i>
        Keuangan
    </a>

    <a href="{{ url('/login') }}" class="mb-3 capitalize font-medium text-sm hover:text-teal-600 transition ease-in-out duration-500">
        <i class="fas fa-sign-in-alt text-xs mr-2"></i>
        Login
    </a>

    <a href="{{ url('/logout') }}" class="mb-3 capitalize font-medium text-sm hover:text-teal-600 transition ease-in-out duration-500">
