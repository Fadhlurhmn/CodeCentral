<!-- start navbar -->
<div id="navbar" class="fixed w-full top-0 z-20 flex flex-row flex-wrap items-center bg-white py-0 px-6 border-b border-gray-300 md:p-6">
    ...
    <div class="w-full flex flex-row items-center justify-between">
      ...
      <button id="sliderBtn" class="hidden flex-none text-right text-2xl p-2 text-gray-900 border border-slate-400 rounded-md md:flex md:text-xl hover:bg-slate-200">
        <i class="fas fa-bars"></i>
      </button>
    </div>
    <!-- end logo -->   

    <button id="navbarToggle" class="hidden"></button>
