                ...
                <table class="mt-2 mb-5 table-auto w-full min-w-max cursor-default text-left border outline-none outline-gray-700">
                    ...
                    <tbody class="bg-white">
                        <tr class="whitespace-nowrap">
                            ...
                            <td><img src="{{ asset('data_ktp/'. $penduduk->foto_ktp) }}" class="img-thumbnail w-20" /></td>
                        </tr>
                        ...
                        <tr class="bg-gray-200/50">
                            <th class="pl-3 py-2 border-r">Alamat KTP</th>
                            <td class="pl-3">{{ $penduduk->alamat_ktp}}</td>
                        </tr>
                        <tr class="whitespace-nowrap">
                            <th class="pl-3 py-2 border-r">Alamat Domisili</th>
                            <td class="pl-3">{{ $penduduk->alamat_domisili }}</td>
                        </tr>
                        <tr class="bg-gray-200/50">
