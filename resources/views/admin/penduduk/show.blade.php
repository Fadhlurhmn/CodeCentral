...
<div class="h-screen flex flex-row flex-wrap">
    ...
    <div class="flex-grow bg-slate-100">
        ...
        <div class="w-full min-w-max p-5 shadow">
            ...
            <a href="{{ route('penduduk') }}" class="text-white bg-teal-400 hover:bg-teal-500 focus:ring-4 focus:outline-none focus:ring-gray-300 font-medium rounded-lg text-sm w-full sm:w-auto px-5 py-2.5 text-center">Kembali</a>      
            @endif
        </div>
    </div>
</div>
