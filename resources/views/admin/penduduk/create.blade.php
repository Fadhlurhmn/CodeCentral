    ...
    <div class="flex-grow bg-slate-100">
        ...
        <div class="w-full min-w-max p-5 shadow">
            ...
            <form class="px-10 py-10 min-w-full bg-white grid grid-cols-2 gap-x-20 gap-y-2 outline-none outline-4 outline-gray-700 rounded-xl" action="{{ route('penduduk.store') }}" method="POST">
                ...
                <div class="relative z-0 w-full mb-5 group">
                    <input type="number" name="rw" id="rw" class="block py-2.5 px-0 w-full text-sm text-black bg-transparent border-0 border-b-2 border-gray-300 appearance-none focus:outline-none focus:ring-0 focus:border-gray-600 peer" placeholder=" " required/>
