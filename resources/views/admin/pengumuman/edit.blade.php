        ...
        <div class="w-full min-w-max p-5 shadow">
            <form class="px-10 py-10 min-w-full bg-white grid grid-cols-4 gap-x-20 gap-y-2 outline-none outline-4 outline-gray-700 rounded-xl" action="{{ url('pengumuman') }}" method="POST">
                ...
                <div class="relative z-0 w-full mb-5 group font-bold col-span-4">
                    <input type="text" name="judul_pengumuman" id="judul_pengumuman" value="{{ $pengumuman->judul_pengumuman }}" class="block py-2.5 px-0 w-full text-sm text-black bg-transparent border-0 border-b-2 border-gray-300 appearance-none focus:outline-none focus:ring-0 focus:border-gray-600 peer" placeholder=" " required />
                ...
                <div class="relative w-full mb-5 group col-span-4">
                    ...
                    <textarea name="deskripsi" id="editor" value="{{ $pengumuman->deskripsi }}" class="normal-case">
                ...
                <div class="relative w-full mb-5 group col-span-4 ">
                    ...
                    <input type="file" value="{{ $pengumuman->lampiran }}" class="block w-full text-sm text-slate-400 border border-slate-400 rounded-xl
