...
<div class="h-screen flex flex-row flex-wrap">
    ...
    <div class="flex-grow bg-white">
        ...
        <div class="w-full h-fit min-w-max p-5">
            <form id="form" class="px-10 py-10 bg-white outline-none outline-4 outline-gray-700 rounded-xl" action="{{ url('admin/jadwal/kebersihan/create') }}" method="POST">
                <h1 class="pb-5 mb-10 font-semibold text-center text-lg rtl:text-right text-gray-900 border-b-2">
                    Isi Jadwal Kebersihan
                </h1>
                @csrf
