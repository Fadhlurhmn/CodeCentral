            ...
            <div class="container h-full bg-white cursor-default">
                ...
                @include('layout.breadcrumb2')
                    ...
                    <div class="mt-10 p-3 border-2 border-teal-400 rounded-lg">
                        ...
                        <a class="p-2 font-normal text-center shadow-md hover:shadow-teal-300 bg-teal-300 hover:bg-teal-400 text-teal-700 hover:text-teal-700 transition duration-300 ease-in-out rounded-lg" href="{{ url('admin/jadwal') }}">Kembali</a>
                    </div>
