                    ...
                    <div class="col-span-full">
                        <table class="min-w-full bg-white border rounded-lg">
                            <thead class="bg-teal-400 text-center">
                                <tr>
                                    <th class="py-2 px-4 font-normal border border-teal-300">Nama</th>
                                    <th class="py-2 px-4 font-normal border border-teal-300">Nomor Telepon</th>
                                ...
                                @foreach ($satpam as $item)
                                    <tr>
                                        <td class="border px-4 py-2">
                                            <input type="hidden" name="id[]" value="{{ $item->id_satpam }}">
                                        ...
                                        <td class="border px-4 py-2">
                                            <input type="text" name="nomor_telepon[]" class="form-control mt-1 block w-full py-2 px-3 border border-gray-300 bg-white rounded-md shadow-sm focus:outline-none focus:ring-gray-500 focus:border-gray-500 sm:text-xs" value="{{ $item->nomor_telepon }}" required>
                                        </td>
        ...
        $('#addRow').click(function() {
            $('#satpamTableBody').append(`
                <tr>
                    ...
                    <td class="border px-4 py-2">
                        <input type="text" name="nomor_telepon[]" class="form-control mt-1 block w-full py-2 px-3 border border-gray-300 bg-white rounded-md shadow-sm focus:outline-none focus:ring-gray-500 focus:border-gray-500 sm:text-xs" required>
                    </td>
                    <td class="border px-4 py-2 text-center">
                        <button type="button" class="removeRow bg-red-600 text-white px-3 py-1 rounded-md shadow hover:bg-red-700">Hapus</button>
                    </td>
