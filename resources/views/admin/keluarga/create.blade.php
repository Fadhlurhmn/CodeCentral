...
<div class="h-screen flex flex-row flex-wrap">
    ...
    <div class="flex-grow bg-slate-100">
        ...
        <div class="w-full min-w-max p-5 shadow">
            ...
            <form class="px-10 py-10 min-w-full bg-white gap-x-20 gap-y-2 outline-none outline-4 outline-gray-700 rounded-xl" action="{{ url('keluarga') }}" method="POST">
                <h1 class="p-5 mb-5 font-semibold text-left rtl:text-right text-gray-900 bg-teal-400 col-span-2 rounded-lg">
                    {{ $page->title }}
                </h1>
                @csrf
                <div class="relative z-0 w-full mb-5 group my-2 font-bold">
