...
<div class="h-screen flex flex-row flex-wrap">
  ...
  <div class="bg-gray-100 flex-1 p-6 md:mt-16"> 
    <h1 class="py-5 ml-5 text-3xl text-gray-900 font-bold">Ini adalah Halaman promosi (HIGH)</h1>

    <div class="container p-5 mb-5 bg-teal-600 text-lg flex justify-between items-center">
      <p class="text-white text-base">Informasi permintaan promosi usaha warga</p>
      <a href="{{ url('admin/promosi/daftar') }}" class="bg-teal-400 text-teal-900 text-center text-base font-medium px-3 py-1 rounded-full">cek daftar permintaan</a>
    </div>
