...
<div class="h-screen flex flex-row flex-wrap">
  ...
  <div class="bg-white flex-1 p-5 md:mt-16 cursor-default border-t-2 border-teal-500">
    ...
    <div class="flex my-5 bg-white rounded-lg border py-3 shadow-md ">
      ...
      @if($promosi->status_pengajuan === 'pending')
      <a href="{{ url('admin/promosi/daftar') }}" class="shadow-md bg-teal-300 hover:bg-teal-400 text-teal-700 hover:text-teal-800 hover:shadow-teal-500 transition duration-300 ease-in-out rounded-lg font-medium text-sm w-full sm:w-auto px-5 py-2.5 text-center">Kembali</a>      
      @else
      <a href="{{ url('admin/promosi/') }}" class="shadow-md bg-teal-300 hover:bg-teal-400 text-teal-700 hover:text-teal-800 hover:shadow-teal-500 transition duration-300 ease-in-out rounded-lg font-medium text-sm w-full sm:w-auto px-5 py-2.5 text-center">Kembali</a>      
      @endif
    @endif
