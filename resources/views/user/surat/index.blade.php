      ...
      <div class="row">
        ...
        <div class="col-12 lg:col-6">
          ...
          <div class="relative">
              ...
              <input type="search" id="search-input" class="block w-full p-4 ps-10 text-sm border border-gray-300 rounded-lg focus:border-primary" placeholder="Cari Surat..." required />
